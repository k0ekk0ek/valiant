...
typedef int(*VT_MAP_OPEN_FUNC)(vt_map_t *, vt_errno_t *);
typedef float(*VT_MAP_SEARCH_FUNC)(vt_map_t *, const char *, size_t, vt_errno_t *);
typedef int(*VT_MAP_CLOSE_FUNC)(vt_map_t *, vt_errno_t *);
typedef int(*VT_MAP_DESTROY_FUNC)(vt_map_t *, vt_errno_t);

struct _vt_map {
  char *name;
  vt_request_member_t member;
  void *data;
  VT_MAP_CONNECT_FUNC open_func;
  VT_MAP_SEARCH_FUNC search_func;
  VT_MAP_DISCONNECT_FUNC close_func;
...
typedef vt_map_t *(*VT_MAP_TYPE_CREATE_MAP_FUNC)(cfg_t *, vt_errno_t *);
...
vt_map_list_t *vt_map_list_create (vt_errno_t *);
int vt_map_list_destroy (vt_map_list_t *, int, vt_errno_t *);
int vt_map_list_cache_reset (const vt_map_list_t *, vt_errno_t *);
int vt_map_list_add_map (vt_map_list_t *, const vt_map_t *, vt_errno_t *);
